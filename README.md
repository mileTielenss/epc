...
- **Foto's**: fotodossier voor het projectdossier (10 jaar bewaarplicht). "Start camera" opent een eigen camerascherm dat open blijft: tik de sluiter zo vaak je wil, daarna "Klaar". "Kies foto's" laadt meerdere foto's tegelijk uit de bibliotheek. De categorie (Algemeen/Gevel/Isolatie/Ruimte/Techniek) is enkel een bijschrift, ook wisselbaar in het camerascherm zelf. Alles komt achteraan de PDF op een aparte pagina "Fotodossier". Dossierfoto's worden bewaard tot max 1600px kwaliteit 0.75.
