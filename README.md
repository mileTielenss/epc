...
- **Ruimtebalk** (op Ramen, Energie en Foto's): kies bovenaan in welke ruimte je staat; alles wat je daarna toevoegt krijgt die ruimte als label. Elke woning start met Living, Keuken, Badkamer, WC, Slaapkamer 1 en 2; "+ Ruimte" voegt er een toe (met autonummering), × verwijdert de gekozen ruimte (items verliezen enkel hun label). Per ruimte cycle je de ventilatie met één knop: geen → natuurlijk → mechanisch → ander (met eigen beschrijving).
...
- **Ramen**: snelle invoer per element met gevelkompas, afmetingen in meter met komma zoals op de digitale meter (bv. 1,335), aantal identieke ramen (stepper), beglazing, kader, rolluik en foto van de afstandhouder. Knop "Zelfde als vorige" herhaalt de laatste invoer met nieuwe afmetingen. Tik op een element in de lijst om het opnieuw te openen en te wijzigen. De lijst en de one-pager staan gesorteerd: eerst voor, dan achter, links en rechts.
- **Energie**: opwekkers toevoegen (gas, stookolie, airco, andere) met wat ze doen (radiatoren, vloerverwarming, sanitair warm water), beschrijving en kenplaatfoto. Bij airco ook kamerafmetingen in meter voor het volume. Daarnaast PV. Tik op een opwekker in de lijst om ze te wijzigen of uit te breiden.
